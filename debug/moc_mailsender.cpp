...
struct qt_meta_stringdata_MailSender_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MailSender_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MailSender_t qt_meta_stringdata_MailSender = {
    {
QT_MOC_LITERAL(0, 0, 10) // "MailSender"
...
const QMetaObject MailSender::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MailSender.data,
      qt_meta_data_MailSender,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MailSender::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MailSender.stringdata0))
